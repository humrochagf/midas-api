    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_boards', to=settings.AUTH_USER_MODEL, verbose_name='owner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='BRL', max_digits=10, validators=[finance.validators.validate_not_zero], verbose_name='value')),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='finance.Board', verbose_name='board')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ...
                ('name', models.CharField(max_length=80, verbose_name='name')),
                ('slug', models.SlugField(verbose_name='slug')),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='finance.Board', verbose_name='board')),
            ],
        ),
        migrations.AddField(
            model_name='entry',
            name='tag',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='entries', to='finance.Tag', verbose_name='tag'),
        ),
    ]
